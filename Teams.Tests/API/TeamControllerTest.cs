...
//     private readonly Mock<IValidator<UpdateTeamManagerCommand>> _updateTeamManagerValidatorMock =
//         new();
...
//     //     _mediatorMock
//     //         .Setup(static m => m.Send(It.IsAny<GetTeamQuery>(), It.IsAny<CancellationToken>()))
//     //         .ReturnsAsync(team);
...
//         _mediatorMock
//             .Setup(m => m.Send(It.IsAny<GetTeamsByManagerQuery>(), It.IsAny<CancellationToken>()))
...
//         var teams = new List<TeamRequestDto> { new TeamRequestDto() };
//         _mediatorMock
//             .Setup(m => m.Send(It.IsAny<GetTeamsByMemberQuery>(), It.IsAny<CancellationToken>()))
//             .Returns(Task.FromResult(teams));
...
//             .Setup(e => e.InsertNewTeamMemberIntoDbAsync(memberId, It.IsAny<CancellationToken>()))
//             .ReturnsAsync(false);
...
//         _employeeServiceMock
//             .Setup(e =>
//                 e.DeleteTeamMemberAsync(dto.MemberId, dto.TeamName!, It.IsAny<CancellationToken>())
//             )
