...
public class TeamProfile : Profile
{
    public TeamProfile()
  {
        ...
        .ForMember(dest => dest.TeamExpirationDate, opt => opt.MapFrom(src => src.ExpirationDate.ToString("dd-MM-yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture)))
        .ForMember(dest => dest.ActiveProject, opt => opt.MapFrom(src => src.MembersIds.Any() && src.Project != null && src.Project.HasActiveProject() ? true : false))
